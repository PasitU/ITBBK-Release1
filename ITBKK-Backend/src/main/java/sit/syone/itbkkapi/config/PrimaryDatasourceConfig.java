...
@Configuration
@EnableJpaRepositories(basePackages = "sit.syone.itbkkapi.primarydatasource.repositories", entityManagerFactoryRef = "primaryEntityMangerFactory", transactionManagerRef = "primaryTransactionManager")
public class PrimaryDatasourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean primaryLocalContainerEntityManagerFactoryBean(){
        ...
        lcemf.setPackagesToScan("sit.syone.itbkkapi.primarydatasource.entities");
        return lcemf;
    }
