...
@Configuration
@EnableJpaRepositories(basePackages = "sit.syone.itbkkapi.userdatasource.repositories", entityManagerFactoryRef = "secondaryEntityMangerFactory", transactionManagerRef = "secondaryTransactionManager")
public class UserDatasourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean secondaryLocalContainerEntityManagerFactoryBean(){
        ...
        lcemf.setPackagesToScan("sit.syone.itbkkapi.userdatasource.entities");
        return lcemf;
    }
